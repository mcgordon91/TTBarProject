...
RVec_f MuonAndJPsiStatisticsAndKinematics::DeltaPhiBetweenIsolatedMuonAndJPsiCalculator()
{
    ...
    for(int i = 0; i < this->Isolated_Muon_phi.size(); i++)
    {
        ...
        {    
                    ...
                    PhiJPsi.push_back(FourVectorTotal.at(j).Phi());
...
RVec_f MuonAndJPsiStatisticsAndKinematics::DeltaRBetweenIsolatedMuonAndJPsiCalculator()
{
    ...
    for(int i = 0; i < this->Isolated_Muon_phi.size(); i++)
    {
        ...
        {    
                    ...
                    EtaJPsi.push_back(FourVectorTotal.at(j).Eta());
                    PhiJPsi.push_back(FourVectorTotal.at(j).Phi());
...
for sample in dictOfListOfFiles:
    ...
    if sample == 'Data':
        ...
        hist['Data']["delta_eta_between_isolated_muon_and_jpsi"] = rdfJPsiMuons['Data'].Histo1D(("Delta Eta for Isolated Muon And JPsi", "Delta Eta for Isolated Muon And JPsi; Delta Eta; Events", 50, 0, 6), "DeltaEtaBetweenIsolatedMuonAndJPsi")
        hist['Data']["delta_phi_between_isolated_muon_and_jpsi"] = rdfJPsiMuons['Data'].Histo1D(("Delta Phi for Isolated Muon And JPsi", "Delta Phi for Isolated Muon And JPsi; Delta Phi; Events", 50, -3.5, 3.5), "DeltaPhiBetweenIsolatedMuonAndJPsi")
        hist['Data']["delta_r_between_isolated_muon_and_jpsi"] = rdfJPsiMuons['Data'].Histo1D(("Delta R for Isolated Muon And JPsi", "Delta R for Isolated Muon And JPsi; Delta R; Events", 50, 0, 6), "DeltaRBetweenIsolatedMuonAndJPsi")
