...
dictOfListOfFiles = {"Data" : listOfFilesData, "MonteCarloTTToSemiLeptonic" : listOfFilesMonteCarloTTToSemiLeptonic, "MonteCarloTTTo2L2Nu" : listOfFilesMonteCarloTTTo2L2Nu, "MonteCarloWJetsToLNu" : listOfFilesMonteCarloWJetsToLNu, "MonteCarloST_tW_top" : listOfFilesMonteCarloST_tW_top, "MonteCarloST_tchannel_top" : listOfFilesMonteCarloST_tchannel_top,                     "MonteCarloMT166" : listOfFilesMonteCarloMT166, "MonteCarloMT169" : listOfFilesMonteCarloMT169, "MonteCarloMT171" : listOfFilesMonteCarloMT171, "MonteCarloMT173" : listOfFilesMonteCarloMT173, "MonteCarloMT175" : listOfFilesMonteCarloMT175, "MonteCarloMT178": listOfFilesMonteCarloMT178} 
...
wgtFormula['MonteCarloMT166'] = "{XS:f} * {lumi:f} * 1000 * genWeight / {sW:f}".format(XS=811.4, lumi=lumiDict["2018"], sW=float(sumweight['MonteCarloMT166'].GetValue()))
wgtFormula['MonteCarloMT169'] = "{XS:f} * {lumi:f} * 1000 * genWeight / {sW:f}".format(XS=746.2, lumi=lumiDict["2018"], sW=float(sumweight['MonteCarloMT169'].GetValue()))
wgtFormula['MonteCarloMT171'] = "{XS:f} * {lumi:f} * 1000 * genWeight / {sW:f}".format(XS=706.1, lumi=lumiDict["2018"], sW=float(sumweight['MonteCarloMT171'].GetValue()))
wgtFormula['MonteCarloMT173'] = "{XS:f} * {lumi:f} * 1000 * genWeight / {sW:f}".format(XS=668.6, lumi=lumiDict["2018"], sW=float(sumweight['MonteCarloMT173'].GetValue()))
wgtFormula['MonteCarloMT175'] = "{XS:f} * {lumi:f} * 1000 * genWeight / {sW:f}".format(XS=633.4, lumi=lumiDict["2018"], sW=float(sumweight['MonteCarloMT175'].GetValue()))
wgtFormula['MonteCarloMT178'] = "{XS:f} * {lumi:f} * 1000 * genWeight / {sW:f}".format(XS=584.6, lumi=lumiDict["2018"], sW=float(sumweight['MonteCarloMT178'].GetValue()))
...
for sample in dictOfListOfFiles:
    ...
    if sample == 'Data':
        ...
        hist['Data']["number_of_jets"] = rdfJPsiMuons['Data'].Histo1D(("number_of_jets", "Number Of Jets; Number Of Jets; Events", 12, 0, 12), "Num_Jets")
        ...
        hist['Data']["number_of_jpsi_muons_initial"] = rdfJPsiMuons['Data'].Histo1D(("number_of_jpsi_muons_initial", "Number of JPsi Muons Before JPsi Muon Cut; Number of Muons; Events",10,0,9), "Num_JPsi_Muons")
        hist['Data']["number_of_jpsi_muons"] = rdfJPsiMuons['Data'].Histo1D(("number_of_jpsi_muons", "Number of JPsi Muons; Number of Muons; Events",7,0,7), "Num_JPsi_Muons")
        hist['Data']["number_of_jpsis"] = rdfJPsiMuons['Data'].Histo1D(("number_of_jpsis", "Number of JPsis; Number of JPsis; Events",4,0,4), "Num_JPsi")

        
        # Final Results
        hist['Data']["leading_isolated_muon_pt"] = rdfJPsiMuons['Data'].Histo1D(("leading_isolated_muon_pt","Leading Isolated Muon Transverse Momentum; Pt (GeV);Events",50,20,220),"LeadingIsolatedMuon_pt")
        hist['Data']["leading_isolated_muon_eta"] = rdfJPsiMuons['Data'].Histo1D(("leading_isolated_muon_eta", "Leading Isolated Muon Pseudorapidity; Eta; Events",30,-3,3),"LeadingIsolatedMuon_eta")
        hist['Data']["leading_isolated_muon_phi"] = rdfJPsiMuons['Data'].Histo1D(("leading_isolated_muon_phi", "Leading Isolated Muon Angle; Phi (Radians); Events",30,-3.5,3.5),"LeadingIsolatedMuon_phi")
        ...
        hist['Data']["isolated_muon_pf_rel_iso_03_all"] = rdfJPsiMuons['Data'].Histo1D(( "isolated_muon_pf_rel_iso_03_all", "Isolated Muon PfRelIso03_All; Isolated Muon PfRelIso03_All; Events", 25, 0, .25), "IsolatedMuon_pfRelIso03_all")
        
        hist['Data']["jet1_pt"] = rdfJPsiMuons['Data'].Histo1D(("jet1_pt", "Jet Transverse Momentum for Leading Jet; Pt (GeV); Events", 50, 20, 200), "SJet1_pt")         
        hist['Data']["jet2_pt"] = rdfJPsiMuons['Data'].Histo1D(("jet2_pt", "Jet Transverse Momentum for Subleading Jet; Pt (GeV); Events", 50, 20, 200), "SJet2_pt")
        hist['Data']["jet1_eta"] = rdfJPsiMuons['Data'].Histo1D(("jet1_eta", "Jet Pseudorapidity for Leading Jet; Eta; Events", 30, -3, 3), "SJet1_eta")
        hist['Data']["jet2_eta"] = rdfJPsiMuons['Data'].Histo1D(("jet2_eta", "Jet Pseudorapidity for Subleading Jet; Eta; Events", 30, -3, 3), "SJet2_eta")
        hist['Data']["jet1_phi"] = rdfJPsiMuons['Data'].Histo1D(("jet1_phi", "Jet Angle for Leading Jet; Phi (Radians); Events", 30, -3.5, 3.5), "SJet1_phi")
        hist['Data']["jet2_phi"] = rdfJPsiMuons['Data'].Histo1D(("jet2_phi", "Jet Angle for Subleading Jet; Phi (Radians); Events", 30, -3.5, 3.5), "SJet2_phi")
        hist['Data']["transverse_mass"] = rdfJPsiMuons['Data'].Histo1D(("transverse_mass", "Transverse Mass; Transverse Mass (GeV); Events", 40, 0, 150), "MTofMETandMu")  
        hist['Data']["ht"] = rdfJPsiMuons['Data'].Histo1D(("ht", "Ht; Ht; Events", 50, 0, 1000), "Ht")
        
        hist['Data']["met"] = rdfJPsiMuons['Data'].Histo1D(("met", "MET; Pt (GeV); Events",50,0,250),"METAfterMETCut")
        ...
        hist['Data']["invariant_mass_jpsi_muons_and_isolated_muons"] = rdfJPsiMuons['Data'].Histo1D(("invariant_mass_jpsi_and_isolated_muons", "Invariant Masses for J/Psi And Isolated Muons; Invariant Masses; Events", 40, 0, 200), "InvariantMassJPsiMuonsAndIsolatedMuons")
        ...
        hist['Data']["jpsi_mass_in_peak"] = rdfJPsiMuons['Data'].Histo1D(("jpsi_mass_in_peak", "J/Psi Mass Made from Muons In Peak; J/Psi Mass; Events", 40, 2.9, 3.3), "JPsiMassInPeak")
        ...
        hist['Data']["jpsi_muons_charge_in_peak"] = rdfJPsiMuons['Data'].Histo1D(("jpsi_muons_charge_in_peak", "J/Psi Muons In Peak Charge; Charge; Events", 5, -2, 2), "JPsiMuon_charge")
        ...
        hist['Data']["jpsi_muons_pt"] = rdfJPsiMuons['Data'].Histo1D(("jpsi_muons_pt", "Transverse Momentum for JPsi Muons; Pt; Events", 50, 0, 50), "JPsiMuon_pt")
        hist['Data']["jpsi_muons_eta"] = rdfJPsiMuons['Data'].Histo1D(("jpsi_muons_eta", "Pseudorapidity for JPsi Muons; Eta; Events", 50, -3, 3), "JPsiMuon_eta")
        hist['Data']["jpsi_muons_phi"] = rdfJPsiMuons['Data'].Histo1D(("jpsi_muons_phi", "Angle for JPsi Muons; Phi; Events", 50, -3.5, 3.5), "JPsiMuon_phi")
        hist['Data']["jpsi_muons_charge"] = rdfJPsiMuons['Data'].Histo1D(("jpsi_muons_charge", "Charge of JPsi Muons; Charge; Events", 5, -2, 2), "JPsiMuon_charge")
        ...
        hist['Data']["delta_r_between_isolated_muon_and_jpsi_in_peak"] = rdfJPsiMuons['Data'].Histo1D(("delta_r_between_isolated_and_jpsi_in_peak", "Delta R Between Isolated Muon And J/Psi; Delta R; Events", 48, 0, 6), "DeltaRBetweenIsolatedMuonAndJPsiInPeak")        

        hist['Data']["mc_truth_purity_delta_r_lower"] = rdfMCTruth['Data'].Histo1D(("mc_truth_purity_delta_r_lower", "Purity Measurement - Delta R Below Cutoff; Purity; Events", 5, -2, 2), "MCTruthPurityDeltaRLowerRVec")
#        hist['Data']["mc_truth_purity_delta_r_higher"] = rdfMCTruth['Data'].Histo1D(("mc_truth_purity_delta_r_higher", "Purity Measurement - Delta R Above Cutoff; Purity; Events", 5, -2, 2), "MCTruthPurityDeltaRHigherRVec")

        hist['Data']["parent_top_pt_same_parent_case"] = rdfMCTruth['Data'].Histo1D(("parent_top_pt_same_parent_case", "Parent Top Pt, Same Parent Case, dR < 2.5; Pt; Events", 60, 0, 300), "ParentTopPtSameParent")
        hist['Data']["parent_top_pt_different_parent_case"] = rdfMCTruth['Data'].Histo1D(("parent_top_pt_different_parent_case", "Isolated Muon Parent Top Pt, Different Parent Case, dR < 2.5; Pt; Events", 60, 0, 300), "ParentTopPtDifferentParent")
        hist['Data']["parent_top_pt_same_parent_case_ht"] = rdfMCTruth['Data'].Histo1D(("parent_top_pt_same_parent_case_ht", "Parent Top Pt, Same Parent Case, Ht > 300; Pt; Events", 80, 0, 400), "ParentTopPtSameParentHt")
        hist['Data']["parent_top_pt_different_parent_case_ht"] = rdfMCTruth['Data'].Histo1D(("parent_top_pt_different_parent_case_ht", "Isolated Muon Parent Top Pt, Different Parent Case, Ht > 300; Pt; Events", 80, 0, 400), "ParentTopPtDifferentParentHt")
        hist['Data']["parent_top_pt_same_parent_case_num_jets"] = rdfMCTruth['Data'].Histo1D(("parent_top_pt_same_parent_case_num_jets", "Parent Top Pt, Same Parent Case, NumJets = 3; Pt; Events", 80, 0, 400), "ParentTopPtSameParentNumJets")
        hist['Data']["parent_top_pt_different_parent_case_num_jets"] = rdfMCTruth['Data'].Histo1D(("parent_top_pt_different_parent_case_num_jets", "J/Psi Muon Parent Top Pt, Different Parent Case, NumJets = 3; Pt; Events", 80, 0, 400), "ParentTopPtDifferentParentNumJets")
        
        hist['Data']["delta_r_vs_ht_with_ht_in_range"] = rdfMCTruth['Data'].Histo2D(("delta_r_vs_ht_with_ht_in_range", "Delta R vs Ht for Ht > 300; Delta R; Ht; Events", 50, 0, 6, 70, 250, 600), "DeltaRBetweenIsolatedMuonAndJPsiInPeakWithHtInRange", "HtInRange")
